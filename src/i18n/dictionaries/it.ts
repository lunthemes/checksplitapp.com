    ...
    steps: [
      {
        ...
        bullets: [
          "Avvio in pochi tocchi",
          "Inviti semplici",
          "Cena, weekend, vacanze, tutto in un'unica logica",
        ],
      },
      {
        ...
        bullets: [
          "Righe assegnate a nome",
          "Piatti condivisi, mance, servizio, tutto conteggiato",
          "Meno 'dividiamo a metà e basta'",
        ],
      },
      {
        ...
        bullets: [
          "Categorie che hanno senso per il gruppo",
          "Foto scontrino o nota condivisa",
          "Una sola sequenza, per tutti",
        ],
      },
      {
        ...
        bullets: [
          "Saldo netto per ognuno",
          "Promemoria opzionali",
          "Estratti facili da inoltrare",
        ],
      },
      {
        ...
        bullets: [
          "Riepilogo chiaro a colpo d'occhio",
          "Link o immagine, come preferite",
          "Rispetto della privacy, per impostazione predefinita",
        ],
      },
    ],
  },
