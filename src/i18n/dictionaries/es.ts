    ...
    steps: [
      {
        ...
        bullets: [
          "Nuevo plan en poco tiempo",
          "Invitación fácil",
          "Cenas, fin de semana, viajes: vale para todo",
        ],
      },
      {
        ...
        bullets: [
          "A cada línea, a quien toque",
          "Raciones a medias, propina, extras",
          "Cuenta justa, sin aproximación rara",
        ],
      },
      {
        ...
        bullets: [
          ...
          "Recibos o recordatorios",
          "Línea de tiempo para el grupo",
        ],
      },
      {
        ...
        bullets: [
          "Saldos neto por persona",
          "Avisos opcionales de pago",
          "Resúmenes fáciles de reenviar",
        ],
      },
      {
        ...
        bullets: [
          "Resúmenes claros de un vistazo",
          "Enlace o imagen",
